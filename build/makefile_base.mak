...
$(WINE_CONFIGURE_FILES64): $(MAKEFILE_DEP) $(ifeq ($(WITH_VKD3D),1),vkd3d64,) | $(WINE_OBJ64)
	cd $(dir $@) && \
		STRIP=$(STRIP_QUOTED) \
...
$(WINE_CONFIGURE_FILES32): $(MAKEFILE_DEP) $(ifeq ($(WITH_VKD3D),1),vkd3d32,) | $(WINE_OBJ32) $(WINE_ORDER_DEPS32)
	cd $(dir $@) && \
		STRIP=$(STRIP_QUOTED) \
